...
class RecycleMenuOrderAdapter(
    private val context: Context,
    private val listOrder: ArrayList<TransaksiModel.ItemTransaksi>,
    private val listener: Listener
) : RecyclerView.Adapter<RecycleMenuOrderAdapter.ViewHolder>() {
    interface Listener {
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        var itemHargaTotal: TextView = itemView.findViewById(R.id.tv_harga_total_item)
...
//            Log.d("Log init=>",listMenu.toString())
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, i: Int) {
        ...
        viewHolder.itemHarga.text = formatRupiah.format(listOrder[i].harga_menu?.toInt())
        viewHolder.jumlahPesanan.text = listOrder[i].jumlah_pesan.toString()
        viewHolder.itemHargaTotal.text = formatRupiah.format(tempHarga)
    }
